...
WebUI.click(findTestObject('Page_Case_Dashboard/Add_a_case_manager_text'))

WebUI.verifyElementText(findTestObject('Page_Case_Dashboard/Change_Case_Manager'), 'Change Case Manager')

WebUI.sendKeys(findTestObject(null), 'Jithin CM')

'Selected client'
WebUI.sendKeys(findTestObject('Page_Case_Dashboard/Case_Popup/input_client_name'), Keys.chord(Keys.ARROW_DOWN))

WebUI.click(findTestObject('Page_Case_Dashboard/Submit'))

WebUI.verifyElementText(findTestObject(null), 'Jithin CM')
